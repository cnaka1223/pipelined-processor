...
IF_pipe_stage if_pipe_stage_inst(
    .clk(clk),
    .reset(reset),
    .en(data_hazard), // from hazard detection
    .branch_address(branch_address), // from ID stage
    .jump_address(jump_address), // from ID stage
    .branch_taken(branch), // from control in ID stage
    .jump(jump), // from control in ID stage
    .pc_plus4(pc_plus4),
    .instr(instr)
    );
...
///////////////////////////// IF/ID registers
    // Complete your code here
pipe_reg_en #(.WIDTH(10)) if_id_pipe_reg1 (
    .clk(clk), 
    .reset(reset),
    .en(data_hazard), 
 ...
 pipe_reg_en #(.WIDTH(32)) if_id_pipe_reg2 (
    .clk(clk), 
    .reset(reset),
    .en(data_hazard), 
    .flush(control_hazard),
...
pipe_reg #(.WIDTH(32))id_ex_pipe_reg3(
    .clk(clk), 
    .reset(reset),
    .d(reg2),
    .q(id_ex_reg2)
    );
 pipe_reg #(.WIDTH(32))id_ex_pipe_reg4(
    .clk(clk), 
    .reset(reset),
    .d(imm_value),
    .q(id_ex_imm_value)
    );   
pipe_reg #(.WIDTH(5))id_ex_pipe_reg5(
    .clk(clk), 
    .reset(reset),
    .d(destination_reg),
    .q(id_ex_destination_reg)
    );    
pipe_reg #(.WIDTH(1))id_ex_pipe_reg6(
    .clk(clk), 
    .reset(reset),
    .d(mem_to_reg),
    .q(id_ex_mem_to_reg)
    );
pipe_reg #(.WIDTH(2))id_ex_pipe_reg7(
    .clk(clk), 
    .reset(reset),
    .d(alu_op),
    .q(id_ex_alu_op)
    );
pipe_reg #(.WIDTH(1))id_ex_pipe_reg8(
    .clk(clk), 
    .reset(reset),
    .d(mem_read),
    .q(id_ex_mem_read)
    );    
 pipe_reg #(.WIDTH(1))id_ex_pipe_reg9(
    .clk(clk), 
    .reset(reset),
    .d(mem_write),
    .q(id_ex_mem_write)
...
pipe_reg #(.WIDTH(1))id_ex_pipe_reg10(
    .clk(clk), 
    .reset(reset),
    .d(alu_src),
    .q(id_ex_alu_src)
    ); 
pipe_reg #(.WIDTH(1))id_ex_pipe_reg11(
    .clk(clk), 
    .reset(reset),
    .d(reg_write),
    .q(id_ex_reg_write)
...
///////////////////////////// EX/MEM registers
	// Complete your code here 
pipe_reg #(.WIDTH(32))ex_mem_pipe_reg1(
    .clk(clk), 
    .reset(reset),
    .d(id_ex_instr),
    .q(ex_mem_instr)
...
pipe_reg #(.WIDTH(5))ex_mem_pipe_reg2(
    .clk(clk), 
    .reset(reset),
    .d(id_ex_destination_reg),
    .q(ex_mem_destination_reg)
    );    
pipe_reg #(.WIDTH(32))ex_mem_pipe_reg3(
    .clk(clk), 
    .reset(reset),
    .d(alu_result),
    .q(ex_mem_alu_result)
    );
pipe_reg #(.WIDTH(32))ex_mem_pipe_reg4(
    .clk(clk), 
    .reset(reset),
    .d(alu_in2_out),
    .q(ex_mem_alu_in2_out)
    );    
pipe_reg #(.WIDTH(1))ex_mem_pipe_reg5(
    .clk(clk), 
    .reset(reset),
    .d(id_ex_mem_to_reg),
    .q(ex_mem_mem_to_reg)
    );    
pipe_reg #(.WIDTH(1))ex_mem_pipe_reg6(
    .clk(clk), 
    .reset(reset),
    .d(id_ex_mem_read),
    .q(ex_mem_mem_read)
    );
pipe_reg #(.WIDTH(1))ex_mem_pipe_reg7(
    .clk(clk), 
    .reset(reset),
    .d(id_ex_mem_write),
    .q(ex_mem_mem_write)
    );
pipe_reg #(.WIDTH(1))ex_mem_pipe_reg8(
    .clk(clk), 
    .reset(reset),
    .d(id_ex_reg_write),
    .q(ex_mem_reg_write)
...
///////////////////////////// MEM/WB registers  
	// Complete your code here
   pipe_reg #(.WIDTH(32))mem_wb_pipe_reg1(
    .clk(clk), 
    .reset(reset),
    .d(ex_mem_alu_result),
    .q(mem_wb_alu_result)
    ...
    pipe_reg #(.WIDTH(32))mem_wb_pipe_reg2(
    .clk(clk), 
    .reset(reset),
    .d(mem_read_data),
    ...
    pipe_reg #(.WIDTH(1))mem_wb_pipe_reg3(
    .clk(clk), 
    .reset(reset),
    .d(ex_mem_mem_to_reg),
    .q(mem_wb_mem_to_reg)
    ...
    pipe_reg #(.WIDTH(1))mem_wb_pipe_reg4(
    .clk(clk), 
    .reset(reset),
    .d(ex_mem_reg_write),
    .q(mem_wb_reg_write)
    ...
    pipe_reg #(.WIDTH(5))mem_wb_pipe_reg5(
    .clk(clk), 
    .reset(reset),
